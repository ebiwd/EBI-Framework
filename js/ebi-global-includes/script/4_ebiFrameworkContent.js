...
function ebiFrameworkUpdateFoot() {
  ...
  '<div class="medium-up-5 small-up-2">' +
    '<div class="column">' +
      '<h5 class="services"><a class="services-color" href="https://www.ebi.ac.uk/services">Services</a></h5><ul>' + ' <li><a href="//www.ebi.ac.uk/services/data-resources-and-tools">Data resources and tools</a></li> ' + ' <li><a href="//www.ebi.ac.uk/submission/">Data submission</a></li> ' + ' <li class="last"><a href="https://www.ebi.ac.uk/support">Help &amp; Support</a></li> ' + ' <li class="first"><a href="https://www.ebi.ac.uk/licencing">Licensing</a></li> ' + '</ul></div>' +
    '<div class="column">' +
