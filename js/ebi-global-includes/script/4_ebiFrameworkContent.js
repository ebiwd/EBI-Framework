...
function ebiFrameworkUpdateFoot() {
  ...
  '<div class="columns small-6 medium-2">' +
    '<h5 class="services"><a class="services-color" href="//www.ebi.ac.uk/services">Services</a></h5><ul>' + ' <li class="first"><a href="//www.ebi.ac.uk/services">By topic</a></li> ' + ' <li><a href="//www.ebi.ac.uk/services/all">By name (A-Z)</a></li> ' + ' <li><a href="//www.ebi.ac.uk/support">Help &amp; Support</a></li> ' + ' <li class="last"><a href="https://www.ebi.ac.uk/licencing">Licensing</a></li> ' + '</ul></div>' +
  '<div class="columns small-6 medium-2">' +
