...
(function includeScripts() {
    var requireScripts = ['//ebi.emblstatic.net/web_guidelines/EBI-Framework/v1.1/js/cookiebanner.js', '//ebi.emblstatic.net/web_guidelines/EBI-Framework/v1.1/js/script.js', '//ebi.emblstatic.net/web_guidelines/js/downtime.js?' + Math.round(new Date().getTime() / 3600000)];
